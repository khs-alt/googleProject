    ...
    methods: {
        ...
        async playVideos() {
            ...
            if (video1 && video2 && toggleVideo) {
                if (video1.currentTime + originalFrame >= video1.duration || video2.currentTime + artifactFrame >= video2.duration
                    || toggleVideo.currentTime + artifactFrame >= toggleVideo.duration || video1.ended || video2.ended || toggleVideo.ended) {
                    video1.currentTime = 0;
                    video2.currentTime = 0;
                    toggleVideo.currentTime = 0;
                }
