...
export default {
  ...
  methods: {
    ...
    serveOriginalImage() {
      return String("http://34.64.62.107/postimage/original/" + this.currentPage)
    },

    serveArtifactImage() {
      return String("http://34.64.62.107/postimage/artifact/" + this.currentPage)
    },

    serveDifferenceImage() {
      return String("http://34.64.62.107/postimage/difference/" + this.currentPage)
    },
