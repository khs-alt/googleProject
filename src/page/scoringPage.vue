        ...
        <div class="videoPlayer">
          <div id="video-margin">
            <div style="margin: 15px;">
              ...
              <div>
                <div class="video-name-style">{{ this.originalVideoNameList[videoNameIndex] }}
                </div>
              </div>
            </div>
            <div style="margin: 15px;">
              ...
              <div>
                <div class="video-name-style">{{ this.artifactVideoNameList[videoNameIndex] }}
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="scoring-button">
        <div style="margin-bottom: 0px;">
          ...
          <button id="videoButton" key="videoButton" @click="changeVideoButton(); changeImgSource()"
            ...
            :class="{ 'btn-style ': !isMouseOverPlay, 'clicked-btn-style': isMouseOverPlay }" class="frame-btn"
...
export default {
  ...
  methods: {
    ...
    removeSuffix() {
      ...
      this.originalImageName = this.originalImageName.replace(/_0\.\d+\.mp4$/, '.mp4');
      this.artifactImageName = this.imageArtifactNameList[this.currentPage]
      this.artifactImageName = this.artifactImageName.replace(/_0\.\d+\.mp4$/, '.mp4');
    },
    // json 받아오는 형식
    ...
    //     // frame * 3 을 하지 않으면 javascript에서 소수점 계산을 잘못하여 에러가 발생
    ...
    //     }
    //     // video 시간을 맞추고 play
    //     const video_current_time = video2.currentTime;
    //     video1.currentTime = video_current_time;
    //     toggleVideo.currentTime = video_current_time;
    //     video1.play();
    //   }
    // },
    ...
    changeVideoButton() {
      console.log("[changeVideoButton]: current videoButtonText: " + this.videoButtonText)
      if (this.videoButtonText == "Play") {
        // this.playVideos();
