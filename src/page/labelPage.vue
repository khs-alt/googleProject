              ...
              <div class="patchName">
                <div class="selected-patch-image"
                  ...
                  <img :src="serveOriginalImage()" class="selected-patch"
                    :style="{ width: (borderBox * 2) + 'px', height: (borderBox * 2) + 'px', right: rightValue + 'px', bottom: bottomValue + 'px' }" alt="original">
                </div>
              ...
              <div class="patchName">
                <div class="selected-patch-image"
                  ...
                  <img :src="serveArtifactImage()" class="selected-patch"
                    :style="{ width: (borderBox * 2) + 'px', height: (borderBox * 2) + 'px', right: rightValue + 'px', bottom: bottomValue + 'px' }" alt="denoised">
                </div>
              ...
              <div class="patchName">
                <div class="selected-patch-image"
                  ...
                  <img :src="serveDifferenceImage()" class="selected-patch"
                    :style="{ width: (borderBox * 2) + 'px', height: (borderBox * 2) + 'px', right: rightValue + 'px', bottom: bottomValue + 'px' }" alt="difference">
                </div>
